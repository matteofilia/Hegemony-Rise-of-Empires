class MainScene extends Phaser.Scene {
    ...
    create() {
        ...
        const text2_1 = (this.add.text(87, 150, "Shanghai", text_style).setOrigin(0.5).rotation =
            Phaser.Math.DegToRad(90));
        const text2_2 = (this.add.text(87, 250, "Shenzhen", text_style).setOrigin(0.5).rotation =
            Phaser.Math.DegToRad(90));
        ...
        const text3_2 = (this.add.text(713, 250, "London", text_style).setOrigin(0.5).rotation =
            Phaser.Math.DegToRad(270));
        const text3_3 = (this.add.text(713, 350, "Paris", text_style).setOrigin(0.5).rotation =
            Phaser.Math.DegToRad(270));
        ...
        const text4_1 = (this.add.text(750, 50, "Cool", text_style_black).setOrigin(0.5).rotation =
            Phaser.Math.DegToRad(45));
        const text5_1 = (this.add.text(50, 50, "Free Parking", text_style_black).setOrigin(0.5).rotation =
            Phaser.Math.DegToRad(45 - 90));
        const text6_1 = (this.add.text(50, 550, "Cool", text_style_black).setOrigin(0.5).rotation =
            Phaser.Math.DegToRad(45));
        const text7_1 = (this.add.text(750, 550, "GO", text_style_black).setOrigin(0.5).rotation = Phaser.Math.DegToRad(
            45 + 270
        ));
